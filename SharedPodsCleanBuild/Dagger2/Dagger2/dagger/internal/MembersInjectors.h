...
#pragma push_macro("DaggerInternalMembersInjectors_INCLUDE_ALL")
#ifdef DaggerInternalMembersInjectors_RESTRICT
#define DaggerInternalMembersInjectors_INCLUDE_ALL 0
#else
#define DaggerInternalMembersInjectors_INCLUDE_ALL 1
#endif
#undef DaggerInternalMembersInjectors_RESTRICT

#if !defined (DaggerInternalMembersInjectors_) && (DaggerInternalMembersInjectors_INCLUDE_ALL || defined(DaggerInternalMembersInjectors_INCLUDE))
...
#pragma pop_macro("DaggerInternalMembersInjectors_INCLUDE_ALL")
