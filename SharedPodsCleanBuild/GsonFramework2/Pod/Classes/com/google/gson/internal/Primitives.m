  ...
  if (self == [ComGoogleGsonInternalPrimitives class]) {
    {
      ...
      ComGoogleGsonInternalPrimitives_PRIMITIVE_TO_WRAPPER_TYPE = JavaUtilCollections_unmodifiableMapWithJavaUtilMap_(primToWrap);
      ComGoogleGsonInternalPrimitives_WRAPPER_TO_PRIMITIVE_TYPE = JavaUtilCollections_unmodifiableMapWithJavaUtilMap_(wrapToPrim);
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "PRIMITIVE_TO_WRAPPER_TYPE", "PRIMITIVE_TO_WRAPPER_TYPE", 0x1a, "Ljava.util.Map;", &ComGoogleGsonInternalPrimitives_PRIMITIVE_TO_WRAPPER_TYPE, "Ljava/util/Map<Ljava/lang/Class<*>;Ljava/lang/Class<*>;>;", .constantValue.asLong = 0 },
    { "WRAPPER_TO_PRIMITIVE_TYPE", "WRAPPER_TO_PRIMITIVE_TYPE", 0x1a, "Ljava.util.Map;", &ComGoogleGsonInternalPrimitives_WRAPPER_TO_PRIMITIVE_TYPE, "Ljava/util/Map<Ljava/lang/Class<*>;Ljava/lang/Class<*>;>;", .constantValue.asLong = 0 },
  };
...
ComGoogleGsonInternalPrimitives *create_ComGoogleGsonInternalPrimitives_init() {
  return new_ComGoogleGsonInternalPrimitives_init();
}
...
jboolean ComGoogleGsonInternalPrimitives_isWrapperTypeWithJavaLangReflectType_(id<JavaLangReflectType> type) {
  ComGoogleGsonInternalPrimitives_initialize();
  return [((id<JavaUtilMap>) nil_chk(ComGoogleGsonInternalPrimitives_WRAPPER_TO_PRIMITIVE_TYPE)) containsKeyWithId:ComGoogleGsonInternal$Gson$Preconditions_checkNotNullWithId_(type)];
}

IOSClass *ComGoogleGsonInternalPrimitives_wrapWithIOSClass_(IOSClass *type) {
  ComGoogleGsonInternalPrimitives_initialize();
  IOSClass *wrapped = [((id<JavaUtilMap>) nil_chk(ComGoogleGsonInternalPrimitives_PRIMITIVE_TO_WRAPPER_TYPE)) getWithId:ComGoogleGsonInternal$Gson$Preconditions_checkNotNullWithId_(type)];
  return (wrapped == nil) ? type : wrapped;
}

IOSClass *ComGoogleGsonInternalPrimitives_unwrapWithIOSClass_(IOSClass *type) {
  ComGoogleGsonInternalPrimitives_initialize();
  IOSClass *unwrapped = [((id<JavaUtilMap>) nil_chk(ComGoogleGsonInternalPrimitives_WRAPPER_TO_PRIMITIVE_TYPE)) getWithId:ComGoogleGsonInternal$Gson$Preconditions_checkNotNullWithId_(type)];
