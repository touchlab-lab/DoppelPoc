...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "readWithComGoogleGsonStreamJsonReader:", "read", "Ljava.sql.Time;", 0x21, "Ljava.io.IOException;", "(Lcom/google/gson/stream/JsonReader;)Ljava/sql/Time;" },
    { "writeWithComGoogleGsonStreamJsonWriter:withId:", "write", "V", 0x21, "Ljava.io.IOException;", "(Lcom/google/gson/stream/JsonWriter;Ljava/sql/Time;)V" },
...
- (ComGoogleGsonTypeAdapter *)createWithComGoogleGsonGson:(ComGoogleGsonGson *)gson
                        withComGoogleGsonReflectTypeToken:(ComGoogleGsonReflectTypeToken *)typeToken {
  return [((ComGoogleGsonReflectTypeToken *) nil_chk(typeToken)) getRawType] == (id) JavaSqlTime_class_() ? new_ComGoogleGsonInternalBindTimeTypeAdapter_init() : nil;
}
