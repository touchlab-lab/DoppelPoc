...
+ (void)initialize {
  if (self == [ComGoogleGsonInternalExcluder class]) {
    ComGoogleGsonInternalExcluder_DEFAULT = new_ComGoogleGsonInternalExcluder_init();
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "DEFAULT", "DEFAULT", 0x19, "Lcom.google.gson.internal.Excluder;", &ComGoogleGsonInternalExcluder_DEFAULT, NULL, .constantValue.asLong = 0 },
...
ComGoogleGsonInternalExcluder *create_ComGoogleGsonInternalExcluder_init() {
  return new_ComGoogleGsonInternalExcluder_init();
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "initWithComGoogleGsonInternalExcluder:withBoolean:withBoolean:withComGoogleGsonGson:withComGoogleGsonReflectTypeToken:", "", NULL, 0x0, NULL, "(Lcom/google/gson/internal/Excluder;ZZLcom/google/gson/Gson;Lcom/google/gson/reflect/TypeToken<TT;>;)V" },
  };
  static const J2ObjcFieldInfo fields[] = {
...
ComGoogleGsonTypeAdapter *ComGoogleGsonInternalExcluder_$1_delegate(ComGoogleGsonInternalExcluder_$1 *self) {
  ...
  return d != nil ? d : (self->delegate_ = [((ComGoogleGsonGson *) nil_chk(self->val$gson_)) getDelegateAdapterWithComGoogleGsonTypeAdapterFactory:self->this$0_ withComGoogleGsonReflectTypeToken:self->val$type_]);
}
...
ComGoogleGsonInternalExcluder_$1 *create_ComGoogleGsonInternalExcluder_$1_initWithComGoogleGsonInternalExcluder_withBoolean_withBoolean_withComGoogleGsonGson_withComGoogleGsonReflectTypeToken_(ComGoogleGsonInternalExcluder *outer$, jboolean capture$0, jboolean capture$1, ComGoogleGsonGson *capture$2, ComGoogleGsonReflectTypeToken *capture$3) {
  return new_ComGoogleGsonInternalExcluder_$1_initWithComGoogleGsonInternalExcluder_withBoolean_withBoolean_withComGoogleGsonGson_withComGoogleGsonReflectTypeToken_(outer$, capture$0, capture$1, capture$2, capture$3);
}
