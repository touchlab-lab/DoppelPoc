...
#pragma push_macro("AndroidOsTrace_INCLUDE_ALL")
#ifdef AndroidOsTrace_RESTRICT
#define AndroidOsTrace_INCLUDE_ALL 0
#else
#define AndroidOsTrace_INCLUDE_ALL 1
#endif
#undef AndroidOsTrace_RESTRICT

#if !defined (AndroidOsTrace_) && (AndroidOsTrace_INCLUDE_ALL || defined(AndroidOsTrace_INCLUDE))
...
#pragma pop_macro("AndroidOsTrace_INCLUDE_ALL")
