...
#pragma push_macro("AndroidOsLooper_INCLUDE_ALL")
#ifdef AndroidOsLooper_RESTRICT
#define AndroidOsLooper_INCLUDE_ALL 0
#else
#define AndroidOsLooper_INCLUDE_ALL 1
#endif
#undef AndroidOsLooper_RESTRICT

#if !defined (AndroidOsLooper_) && (AndroidOsLooper_INCLUDE_ALL || defined(AndroidOsLooper_INCLUDE))
#define AndroidOsLooper_

#define AndroidOsThreadNudger_RESTRICT 1
#define AndroidOsThreadNudger_INCLUDE 1
...
#if !defined (AndroidOsLooper_Profiler_) && (AndroidOsLooper_INCLUDE_ALL || defined(AndroidOsLooper_Profiler_INCLUDE))
#define AndroidOsLooper_Profiler_

@class AndroidOsMessage;

@protocol AndroidOsLooper_Profiler < NSObject, JavaObject >
...
#pragma pop_macro("AndroidOsLooper_INCLUDE_ALL")
