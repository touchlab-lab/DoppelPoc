...
#pragma push_macro("AndroidOsHandler_INCLUDE_ALL")
#ifdef AndroidOsHandler_RESTRICT
#define AndroidOsHandler_INCLUDE_ALL 0
#else
#define AndroidOsHandler_INCLUDE_ALL 1
#endif
#undef AndroidOsHandler_RESTRICT

#if !defined (AndroidOsHandler_) && (AndroidOsHandler_INCLUDE_ALL || defined(AndroidOsHandler_INCLUDE))
...
#if !defined (AndroidOsHandler_Callback_) && (AndroidOsHandler_INCLUDE_ALL || defined(AndroidOsHandler_Callback_INCLUDE))
#define AndroidOsHandler_Callback_

@class AndroidOsMessage;

@protocol AndroidOsHandler_Callback < NSObject, JavaObject >
...
#pragma pop_macro("AndroidOsHandler_INCLUDE_ALL")
