...
#pragma push_macro("CoTouchlabAndroidThreadingTasksTask_INCLUDE_ALL")
#ifdef CoTouchlabAndroidThreadingTasksTask_RESTRICT
#define CoTouchlabAndroidThreadingTasksTask_INCLUDE_ALL 0
#else
#define CoTouchlabAndroidThreadingTasksTask_INCLUDE_ALL 1
#endif
#undef CoTouchlabAndroidThreadingTasksTask_RESTRICT

#if !defined (CoTouchlabAndroidThreadingTasksTask_) && (CoTouchlabAndroidThreadingTasksTask_INCLUDE_ALL || defined(CoTouchlabAndroidThreadingTasksTask_INCLUDE))
...
#pragma pop_macro("CoTouchlabAndroidThreadingTasksTask_INCLUDE_ALL")
