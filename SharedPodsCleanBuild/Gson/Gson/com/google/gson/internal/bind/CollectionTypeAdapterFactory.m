...
ComGoogleGsonInternalBindCollectionTypeAdapterFactory *create_ComGoogleGsonInternalBindCollectionTypeAdapterFactory_initWithComGoogleGsonInternalConstructorConstructor_(ComGoogleGsonInternalConstructorConstructor *constructorConstructor) {
  return new_ComGoogleGsonInternalBindCollectionTypeAdapterFactory_initWithComGoogleGsonInternalConstructorConstructor_(constructorConstructor);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithComGoogleGsonGson:withJavaLangReflectType:withComGoogleGsonTypeAdapter:withComGoogleGsonInternalObjectConstructor:", "Adapter", NULL, 0x1, NULL, "(Lcom/google/gson/Gson;Ljava/lang/reflect/Type;Lcom/google/gson/TypeAdapter<TE;>;Lcom/google/gson/internal/ObjectConstructor<+Ljava/util/Collection<TE;>;>;)V" },
    { "readWithComGoogleGsonStreamJsonReader:", "read", "Ljava.util.Collection;", 0x1, "Ljava.io.IOException;", "(Lcom/google/gson/stream/JsonReader;)Ljava/util/Collection<TE;>;" },
    { "writeWithComGoogleGsonStreamJsonWriter:withId:", "write", "V", 0x1, "Ljava.io.IOException;", "(Lcom/google/gson/stream/JsonWriter;Ljava/util/Collection<TE;>;)V" },
  };
  static const J2ObjcFieldInfo fields[] = {
...
ComGoogleGsonInternalBindCollectionTypeAdapterFactory_Adapter *create_ComGoogleGsonInternalBindCollectionTypeAdapterFactory_Adapter_initWithComGoogleGsonGson_withJavaLangReflectType_withComGoogleGsonTypeAdapter_withComGoogleGsonInternalObjectConstructor_(ComGoogleGsonGson *context, id<JavaLangReflectType> elementType, ComGoogleGsonTypeAdapter *elementTypeAdapter, id<ComGoogleGsonInternalObjectConstructor> constructor) {
  return new_ComGoogleGsonInternalBindCollectionTypeAdapterFactory_Adapter_initWithComGoogleGsonGson_withJavaLangReflectType_withComGoogleGsonTypeAdapter_withComGoogleGsonInternalObjectConstructor_(context, elementType, elementTypeAdapter, constructor);
}
