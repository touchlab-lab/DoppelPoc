...
- (void)addWithJavaLangBoolean:(JavaLangBoolean *)bool_ {
  [((id<JavaUtilList>) nil_chk(elements_)) addWithId:bool_ == nil ? JreLoadStatic(ComGoogleGsonJsonNull, INSTANCE) : new_ComGoogleGsonJsonPrimitive_initWithJavaLangBoolean_(bool_)];
}

- (void)addWithJavaLangCharacter:(JavaLangCharacter *)character {
  [((id<JavaUtilList>) nil_chk(elements_)) addWithId:character == nil ? JreLoadStatic(ComGoogleGsonJsonNull, INSTANCE) : new_ComGoogleGsonJsonPrimitive_initWithJavaLangCharacter_(character)];
}

- (void)addWithNSNumber:(NSNumber *)number {
  [((id<JavaUtilList>) nil_chk(elements_)) addWithId:number == nil ? JreLoadStatic(ComGoogleGsonJsonNull, INSTANCE) : new_ComGoogleGsonJsonPrimitive_initWithNSNumber_(number)];
}

- (void)addWithNSString:(NSString *)string {
  [((id<JavaUtilList>) nil_chk(elements_)) addWithId:string == nil ? JreLoadStatic(ComGoogleGsonJsonNull, INSTANCE) : new_ComGoogleGsonJsonPrimitive_initWithNSString_(string)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _ComGoogleGsonJsonArray = { 2, "JsonArray", "com.google.gson", NULL, 0x11, 29, methods, 1, fields, 0, NULL, 0, NULL, NULL, "Lcom/google/gson/JsonElement;Ljava/lang/Iterable<Lcom/google/gson/JsonElement;>;" };
