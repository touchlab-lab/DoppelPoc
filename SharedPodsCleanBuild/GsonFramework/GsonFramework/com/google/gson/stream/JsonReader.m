...
- (jint)doPeek {
  ...
  if (peekStack == ComGoogleGsonStreamJsonScope_EMPTY_ARRAY) {
    ...
    *IOSIntArray_GetRef(stack_, stackSize_ - 1) = ComGoogleGsonStreamJsonScope_NONEMPTY_DOCUMENT;
  }
...
- (jdouble)nextDouble {
  ...
  if (!lenient_ && (JavaLangDouble_isNaNWithDouble_(result) || JavaLangDouble_isInfiniteWithDouble_(result))) {
    @throw new_ComGoogleGsonStreamMalformedJsonException_initWithNSString_(JreStrcat("$D$I$I$$", @"JSON forbids NaN and infinities: ", result, @" at line ", [self getLineNumber], @" column ", [self getColumnNumber], @" path ", [self getPath]));
  }
  peekedString_ = nil;
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
+ (void)initialize {
  if (self == [ComGoogleGsonStreamJsonReader class]) {
    ...
    {
      *JreLoadStaticRef(ComGoogleGsonInternalJsonReaderInternalAccess, INSTANCE) = new_ComGoogleGsonStreamJsonReader_$1_init();
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "NON_EXECUTE_PREFIX", "NON_EXECUTE_PREFIX", 0x1a, "[C", &ComGoogleGsonStreamJsonReader_NON_EXECUTE_PREFIX, NULL, .constantValue.asLong = 0 },
    { "MIN_INCOMPLETE_INTEGER", "MIN_INCOMPLETE_INTEGER", 0x1a, "J", NULL, NULL, .constantValue.asLong = ComGoogleGsonStreamJsonReader_MIN_INCOMPLETE_INTEGER },
    { "PEEKED_NONE", "PEEKED_NONE", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_NONE },
    { "PEEKED_BEGIN_OBJECT", "PEEKED_BEGIN_OBJECT", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_BEGIN_OBJECT },
    { "PEEKED_END_OBJECT", "PEEKED_END_OBJECT", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_END_OBJECT },
    { "PEEKED_BEGIN_ARRAY", "PEEKED_BEGIN_ARRAY", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_BEGIN_ARRAY },
    { "PEEKED_END_ARRAY", "PEEKED_END_ARRAY", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_END_ARRAY },
    { "PEEKED_TRUE", "PEEKED_TRUE", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_TRUE },
    { "PEEKED_FALSE", "PEEKED_FALSE", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_FALSE },
    { "PEEKED_NULL", "PEEKED_NULL", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_NULL },
    { "PEEKED_SINGLE_QUOTED", "PEEKED_SINGLE_QUOTED", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_SINGLE_QUOTED },
    { "PEEKED_DOUBLE_QUOTED", "PEEKED_DOUBLE_QUOTED", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_DOUBLE_QUOTED },
    { "PEEKED_UNQUOTED", "PEEKED_UNQUOTED", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_UNQUOTED },
    { "PEEKED_BUFFERED", "PEEKED_BUFFERED", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_BUFFERED },
    { "PEEKED_SINGLE_QUOTED_NAME", "PEEKED_SINGLE_QUOTED_NAME", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_SINGLE_QUOTED_NAME },
    { "PEEKED_DOUBLE_QUOTED_NAME", "PEEKED_DOUBLE_QUOTED_NAME", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_DOUBLE_QUOTED_NAME },
    { "PEEKED_UNQUOTED_NAME", "PEEKED_UNQUOTED_NAME", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_UNQUOTED_NAME },
    { "PEEKED_LONG", "PEEKED_LONG", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_LONG },
    { "PEEKED_NUMBER", "PEEKED_NUMBER", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_NUMBER },
    { "PEEKED_EOF", "PEEKED_EOF", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_PEEKED_EOF },
    { "NUMBER_CHAR_NONE", "NUMBER_CHAR_NONE", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_NUMBER_CHAR_NONE },
    { "NUMBER_CHAR_SIGN", "NUMBER_CHAR_SIGN", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_NUMBER_CHAR_SIGN },
    { "NUMBER_CHAR_DIGIT", "NUMBER_CHAR_DIGIT", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_NUMBER_CHAR_DIGIT },
    { "NUMBER_CHAR_DECIMAL", "NUMBER_CHAR_DECIMAL", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_NUMBER_CHAR_DECIMAL },
    { "NUMBER_CHAR_FRACTION_DIGIT", "NUMBER_CHAR_FRACTION_DIGIT", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_NUMBER_CHAR_FRACTION_DIGIT },
    { "NUMBER_CHAR_EXP_E", "NUMBER_CHAR_EXP_E", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_NUMBER_CHAR_EXP_E },
    { "NUMBER_CHAR_EXP_SIGN", "NUMBER_CHAR_EXP_SIGN", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_NUMBER_CHAR_EXP_SIGN },
    { "NUMBER_CHAR_EXP_DIGIT", "NUMBER_CHAR_EXP_DIGIT", 0x1a, "I", NULL, NULL, .constantValue.asInt = ComGoogleGsonStreamJsonReader_NUMBER_CHAR_EXP_DIGIT },
...
ComGoogleGsonStreamJsonReader *create_ComGoogleGsonStreamJsonReader_initWithJavaIoReader_(JavaIoReader *inArg) {
  return new_ComGoogleGsonStreamJsonReader_initWithJavaIoReader_(inArg);
}
...
JavaIoIOException *ComGoogleGsonStreamJsonReader_syntaxErrorWithNSString_(ComGoogleGsonStreamJsonReader *self, NSString *message) {
  @throw new_ComGoogleGsonStreamMalformedJsonException_initWithNSString_(JreStrcat("$$I$I$$", message, @" at line ", [self getLineNumber], @" column ", [self getColumnNumber], @" path ", [self getPath]));
}
...
ComGoogleGsonStreamJsonReader_$1 *create_ComGoogleGsonStreamJsonReader_$1_init() {
  return new_ComGoogleGsonStreamJsonReader_$1_init();
}
