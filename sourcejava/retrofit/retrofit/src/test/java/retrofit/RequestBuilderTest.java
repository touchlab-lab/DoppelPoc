...
import retrofit.client.ClientHeader;
...
public class RequestBuilderTest {
  ...
  @Test public void simpleHeaders() {
    ...
    assertThat(request.getHeaders()) //
        .containsExactly(new ClientHeader("ping", "pong"), new ClientHeader("kit", "kat"));
    assertThat(request.getUrl()).isEqualTo("http://example.com/foo/bar/");
    assertThat(request.getBody()).isNull();
  }
  ...
  @Test public void allThreeHeaderTypes() {
    ...
    assertThat(request.getMethod()).isEqualTo("GET");
    assertThat(request.getHeaders()).containsExactly(new ClientHeader("ping", "pong"),
        new ClientHeader("kit", "kat"), new ClientHeader("fizz", "buzz"));
    assertThat(request.getUrl()).isEqualTo("http://example.com/foo/bar/");
    assertThat(request.getBody()).isNull();
  }
  ...
  @Test public void headerParamToString() {
    ...
    assertThat(request.getMethod()).isEqualTo("GET");
    assertThat(request.getHeaders()) //
        .containsExactly(new ClientHeader("kit", "1234"));
    assertThat(request.getUrl()).isEqualTo("http://example.com/foo/bar/");
    assertThat(request.getBody()).isNull();
  }
  ...
  @Test public void headerParamList() {
    ...
    assertThat(request.getMethod()).isEqualTo("GET");
    assertThat(request.getHeaders()) //
        .containsExactly(new ClientHeader("foo", "bar"), new ClientHeader("foo", "baz"));
    assertThat(request.getUrl()).isEqualTo("http://example.com/foo/bar/");
    assertThat(request.getBody()).isNull();
  }
  ...
  @Test public void contentTypeAnnotationHeaderAddsHeaderWithNoBody() {
    ...
    Request request = buildRequest(Example.class);
    assertThat(request.getHeaders()).contains(new ClientHeader("Content-Type", "text/not-plain"));
  }
