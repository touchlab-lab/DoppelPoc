...
public final class SpdyStream {
  ...
  private final List<SpdyHeader> requestHeaders;

  /** Headers sent in the stream reply. Null if reply is either not sent or not sent yet. */
  private List<SpdyHeader> responseHeaders;
  ...
  SpdyStream(int id, SpdyConnection connection, boolean outFinished, boolean inFinished,
      List<SpdyHeader> requestHeaders) {
  ...
  public List<SpdyHeader> getRequestHeaders() {
   ...
   */
  public synchronized List<SpdyHeader> getResponseHeaders() throws IOException {
    readTimeout.enter();
    try {
   ...
   */
  public void reply(List<SpdyHeader> responseHeaders, boolean out) throws IOException {
  ...
  void receiveHeaders(List<SpdyHeader> headers, HeadersMode headersMode) {
    assert (!Thread.holdsLock(SpdyStream.this));
    ...
    synchronized (this) {
      if (responseHeaders == null) {
        ...
        if (headersMode.failIfHeadersPresent()) {
          ...
          List<SpdyHeader> newHeaders = new ArrayList<>();
