...
public final class Spdy3 implements Variant {
  ...
  static final class Reader implements FrameReader {
    ...
    private void readSynStream(Handler handler, int flags, int length) throws IOException {
      ...
      List<SpdyHeader> headerBlock = headerBlockReader.readNameValueBlock(length - 10);
    ...
    private void readSynReply(Handler handler, int flags, int length) throws IOException {
      int w1 = source.readInt();
      int streamId = w1 & 0x7fffffff;
      List<SpdyHeader> headerBlock = headerBlockReader.readNameValueBlock(length - 4);
      boolean inFinished = (flags & FLAG_FIN) != 0;
  ...
  static final class Writer implements FrameWriter {
    ...
    @Override public synchronized void synStream(boolean outFinished, boolean inFinished,
        int streamId, int associatedStreamId, List<SpdyHeader> headerBlock)
        throws IOException {
      if (closed) throw new IOException("closed");
    ...
    @Override public synchronized void synReply(boolean outFinished, int streamId,
        List<SpdyHeader> headerBlock) throws IOException {
      if (closed) throw new IOException("closed");
      writeNameValueBlockToBuffer(headerBlock);
    ...
    @Override public synchronized void headers(int streamId, List<SpdyHeader> headerBlock)
        throws IOException {
      if (closed) throw new IOException("closed");
      writeNameValueBlockToBuffer(headerBlock);
      int flags = 0;
    ...
    private void writeNameValueBlockToBuffer(List<SpdyHeader> headerBlock) throws IOException {
