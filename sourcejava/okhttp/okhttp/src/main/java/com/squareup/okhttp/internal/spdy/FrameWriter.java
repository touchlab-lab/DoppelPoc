...
public interface FrameWriter extends Closeable {
   ...
   */
  void pushPromise(int streamId, int promisedStreamId, List<SpdyHeader> requestHeaders)
      throws IOException;
  ...
  void synReply(boolean outFinished, int streamId, List<SpdyHeader> headerBlock)
      throws IOException;
  void headers(int streamId, List<SpdyHeader> headerBlock) throws IOException;
