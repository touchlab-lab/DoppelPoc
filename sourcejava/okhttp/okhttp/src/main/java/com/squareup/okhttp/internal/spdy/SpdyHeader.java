...
public final class SpdyHeader
{
  ...
  public SpdyHeader(String name, String value) {
    this(ByteString.encodeUtf8(name), ByteString.encodeUtf8(value));
  }

  public SpdyHeader(ByteString name, String value) {
    this(name, ByteString.encodeUtf8(value));
  }

  public SpdyHeader(ByteString name, ByteString value) {
    this.name = name;
    this.value = value;
  ...
  @Override public boolean equals(Object other) {
    if (other instanceof SpdyHeader) {
      SpdyHeader that = (SpdyHeader) other;
