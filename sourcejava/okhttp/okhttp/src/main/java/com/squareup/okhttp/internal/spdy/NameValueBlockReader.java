...
class NameValueBlockReader {
  ...
  public List<SpdyHeader> readNameValueBlock(int length) throws IOException {
    ...
    List<SpdyHeader> entries = new ArrayList<>(numberOfPairs);
    for (int i = 0; i < numberOfPairs; i++) {
      ...
      entries.add(new SpdyHeader(name, values));
    }
