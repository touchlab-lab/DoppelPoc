...
public class HpackDraft10Test {
  ...
  @Test public void largeHeaderValue() throws IOException {
    ...
    Arrays.fill(value, '!');
    List<SpdyHeader> headerBlock = headerEntries("cookie", new String(value));
  ...
  @Test public void testEviction() throws IOException {
    ...
    SpdyHeader entry = hpackReader.dynamicTable[headerTableLength() - 1];
  ...
  @Test public void literalHeaderFieldWithoutIndexingIndexedName() throws IOException {
    List<SpdyHeader> headerBlock = headerEntries(":path", "/sample/path");
  ...
  @Test public void literalHeaderFieldWithoutIndexingNewName() throws IOException {
    List<SpdyHeader> headerBlock = headerEntries("custom-key", "custom-header");
  ...
  private void checkReadSecondRequestWithoutHuffman() {
    ...
    SpdyHeader entry = hpackReader.dynamicTable[headerTableLength() - 2];
  ...
  private void checkReadThirdRequestWithoutHuffman() {
    ...
    SpdyHeader entry = hpackReader.dynamicTable[headerTableLength() - 3];
  ...
  @Test public void lowercaseHeaderNameBeforeEmit() throws IOException {
    hpackWriter.writeHeaders(Arrays.asList(new SpdyHeader("FoO", "BaR")));
  ...
  private void checkEntry(SpdyHeader entry, String name, String value, int size) {
