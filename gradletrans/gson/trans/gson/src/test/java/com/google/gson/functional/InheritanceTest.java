...
import com.google.gson.doppel.JsonCompare;
...
public class InheritanceTest extends TestCase {
  ...
  public void testSubClassSerialization() throws Exception {
    ...
    String expectedJson = target.getExpectedJson();
    String gsonJson = gson.toJson(target);
    System.out.println("expectedJson: "+ expectedJson);
    System.out.println("gsonJson: "+ gsonJson);
    System.out.println("currenttime: "+ System.currentTimeMillis());
    JsonCompare.jsonSameAssert(expectedJson, gsonJson);
  }
  ...
  @DoppelHacks //final field and reflection doesn't work
