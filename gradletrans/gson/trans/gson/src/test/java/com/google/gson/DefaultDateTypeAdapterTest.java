...
public class DefaultDateTypeAdapterTest extends TestCase {
  ...
  private void assertFormattingAlwaysEmitsUsLocale(Locale locale) {
    ...
    try {
      ...
      assertFormatted("January 1, 1970 12:00:00 AM "+ platformUTCString(),
          new DefaultDateTypeAdapter(DateFormat.LONG, DateFormat.LONG));
      assertFormatted("Thursday, January 1, 1970 12:00:00 AM "+ platformUTCString(),
  ...
  private String platformUTCString()
  {
    return PlatformUtils.isJ2objc() ? "GMT+00:00" : "UTC";
  }
