...
public final class DaoConfig implements Cloneable {
    ...
    private static Property[] reflectProperties(Class<? extends AbstractDao<?, ?>> daoClass)
        ...
        try
        {
            basicInstance = propertiesClass.newInstance();
        }
        catch(InstantiationException e)
        {
            Log.e("DaoConfig", "Damn", e);
        ...
        for (Field field : fields) {
            ...
            if ((field.getModifiers() & modifierMask) == modifierMask) {
                Object fieldValue = field.get(basicInstance);
                if(fieldValue == null)
                {
                    Log.w("DaoConfig", "field null: "+ field.getName());
                    continue;
                }
                ...
                /*if (fieldValue instanceof Property) */{
                    try
                    {
                        Log.w("DaoConfig", "fieldname: "+ fieldValue.getClass().getName());
                    }
                    catch(Exception e)
                    {
                        Log.e("DaoConfig", "oh boy", e);
