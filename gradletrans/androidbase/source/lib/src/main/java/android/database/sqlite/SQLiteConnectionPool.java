...
import android.system.CloseGuard;
...
public final class SQLiteConnectionPool implements Closeable {
    ...
    private final ArrayList<SQLiteConnection> mAvailableNonPrimaryConnections = new ArrayList<SQLiteConnection>();
    ...
    private final WeakHashMap<SQLiteConnection, AcquiredConnectionStatus> mAcquiredConnections = new WeakHashMap<SQLiteConnection, AcquiredConnectionStatus>();
