...
/**
  ...
  *  }</pre>
  */
public class Looper implements ThreadNudger {
...
//        final long ident = Binder.clearCallingIdentity();
        ...
        while (true) {
            ...
            if(msg == null)
            {
                //Looper no longer manages the thread. Keeping the construct for sanity, but otherwise,
                //we let the host deal with us.
                return;
            }
            else
            {
