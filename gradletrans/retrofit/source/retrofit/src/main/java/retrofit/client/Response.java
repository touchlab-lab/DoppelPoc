...
public final class Response {
  ...
  private final List<ClientHeader> headers;
  private final TypedInput body;

  public Response(String url, int status, String reason, List<ClientHeader> headers, TypedInput body) {
    if (url == null) {
    ...
    this.status = status;
    this.reason = reason;
    this.headers = Collections.unmodifiableList(new ArrayList<ClientHeader>(headers));
    this.body = body;
  }
  ...
  public List<ClientHeader> getHeaders() {
    return headers;
  }
