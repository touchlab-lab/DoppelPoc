...
final class RequestBuilder implements RequestInterceptor.RequestFacade {
  ...
  private List<ClientHeader> headers;
  ...
  RequestBuilder(String apiUrl, RestMethodInfo methodInfo, Converter converter) {
    ...
    if (methodInfo.headers != null) {
      headers = new ArrayList<ClientHeader>(methodInfo.headers);
    }
  ...
  @Override public void addHeader(String name, String value) {
    ...
    List<ClientHeader> headers = this.headers;
    if (headers == null) {
      this.headers = headers = new ArrayList<ClientHeader>(2);
    }
    headers.add(new ClientHeader(name, value));
  }
  ...
  Request build() throws UnsupportedEncodingException {
    ...
    if (contentTypeHeader != null) {
      if (body != null) {
        ...
        ClientHeader header = new ClientHeader("Content-Type", contentTypeHeader);
        if (headers == null) {
