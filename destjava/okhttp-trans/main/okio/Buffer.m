...
//  source: /Users/kgalligan/devel/xp/sourcejava/okhttp/okhttp/src/main/java/okio/Buffer.java
//
...
- (OkioBuffer *)copyToWithJavaIoOutputStream:(JavaIoOutputStream *)outArg
  ...
  OkioOkioUtil_checkOffsetAndCountWithLong_withLong_withLong_(size_, offset, byteCount);
...
- (OkioBuffer *)writeToWithJavaIoOutputStream:(JavaIoOutputStream *)outArg
                                     withLong:(jlong)byteCount {
  if (outArg == nil) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"out == null");
  OkioOkioUtil_checkOffsetAndCountWithLong_withLong_withLong_(size_, 0, byteCount);
  OkioSegment *s = head_;
  while (byteCount > 0) {
...
- (jbyte)getByteWithLong:(jlong)pos {
  OkioOkioUtil_checkOffsetAndCountWithLong_withLong_withLong_(size_, pos, 1);
...
- (jshort)readShortLe {
  return OkioOkioUtil_reverseBytesShortWithShort_([self readShort]);
}

- (jint)readIntLe {
  return OkioOkioUtil_reverseBytesIntWithInt_([self readInt]);
}

- (jlong)readLongLe {
  return OkioOkioUtil_reverseBytesLongWithLong_([self readLong]);
}
...
- (NSString *)readUtf8 {
  @try {
    return [self readStringWithLong:size_ withJavaNioCharsetCharset:JreLoadStatic(OkioOkioUtil, UTF_8)];
  }
...
- (NSString *)readUtf8WithLong:(jlong)byteCount {
  return [self readStringWithLong:byteCount withJavaNioCharsetCharset:JreLoadStatic(OkioOkioUtil, UTF_8)];
}
...
- (IOSByteArray *)readByteArrayWithLong:(jlong)byteCount {
  OkioOkioUtil_checkOffsetAndCountWithLong_withLong_withLong_(self->size_, 0, byteCount);
  if (byteCount > JavaLangInteger_MAX_VALUE) {
    @throw new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$J", @"byteCount > Integer.MAX_VALUE: ", byteCount));
  }
...
- (jint)readWithByteArray:(IOSByteArray *)sink
                  withInt:(jint)offset
                  withInt:(jint)byteCount {
  OkioOkioUtil_checkOffsetAndCountWithLong_withLong_withLong_(((IOSByteArray *) nil_chk(sink))->size_, offset, byteCount);
...
- (OkioBuffer *)writeStringWithNSString:(NSString *)string
  ...
  if (string == nil) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"string == null");
  if (charset == nil) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"charset == null");
  if ([((JavaNioCharsetCharset *) nil_chk(charset)) isEqual:JreLoadStatic(OkioOkioUtil, UTF_8)]) return [self writeUtf8WithNSString:string];
...
- (OkioBuffer *)writeWithByteArray:(IOSByteArray *)source
                           ...
                           withInt:(jint)byteCount {
  if (source == nil) @throw new_JavaLangIllegalArgumentException_initWithNSString_(@"source == null");
  OkioOkioUtil_checkOffsetAndCountWithLong_withLong_withLong_(((IOSByteArray *) nil_chk(source))->size_, offset, byteCount);
...
- (OkioBuffer *)writeShortLeWithInt:(jint)s {
  return [self writeShortWithInt:OkioOkioUtil_reverseBytesShortWithShort_((jshort) s)];
}
...
- (OkioBuffer *)writeIntLeWithInt:(jint)i {
  return [self writeIntWithInt:OkioOkioUtil_reverseBytesIntWithInt_(i)];
}
...
- (OkioBuffer *)writeLongLeWithLong:(jlong)v {
  return [self writeLongWithLong:OkioOkioUtil_reverseBytesLongWithLong_(v)];
}
