...
@interface ComGoogleGsonInternalBindDateTypeAdapter_$1 : NSObject < DPGSTypeAdapterFactory >
...
id<DPGSTypeAdapterFactory> ComGoogleGsonInternalBindDateTypeAdapter_FACTORY;
...
- (void)writeWithDPGSStreamJsonWriter:(DPGSStreamJsonWriter *)outArg
  ...
  @synchronized(self) {
    ...
    (void) [((DPGSStreamJsonWriter *) nil_chk(outArg)) valueWithNSString:dateFormatAsString];
  }
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "readWithDPGSStreamJsonReader:", "read", "Ljava.util.Date;", 0x1, "Ljava.io.IOException;", "(Lcom/google/gson/stream/JsonReader;)Ljava/util/Date;" },
    { "deserializeToDateWithNSString:", "deserializeToDate", "Ljava.util.Date;", 0x22, NULL, NULL },
    { "writeWithDPGSStreamJsonWriter:withId:", "write", "V", 0x21, "Ljava.io.IOException;", "(Lcom/google/gson/stream/JsonWriter;Ljava/util/Date;)V" },
...
JavaUtilDate *ComGoogleGsonInternalBindDateTypeAdapter_deserializeToDateWithNSString_(ComGoogleGsonInternalBindDateTypeAdapter *self, NSString *json) {
  @synchronized(self) {
    ...
    @catch (JavaTextParseException *e) {
      @throw new_DPGSJsonSyntaxException_initWithNSString_withNSException_(json, e);
    }
  }
}
...
- (DPGSTypeAdapter *)createWithDPGSGson:(DPGSGson *)gson
               withDPGSReflectTypeToken:(DPGSReflectTypeToken *)typeToken {
  return [((DPGSReflectTypeToken *) nil_chk(typeToken)) getRawType] == (id) JavaUtilDate_class_() ? new_ComGoogleGsonInternalBindDateTypeAdapter_init() : nil;
}
