...
@interface ComGoogleGsonInternalBindSqlDateTypeAdapter_$1 : NSObject < DPGSTypeAdapterFactory >
...
id<DPGSTypeAdapterFactory> ComGoogleGsonInternalBindSqlDateTypeAdapter_FACTORY;
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "readWithDPGSStreamJsonReader:", "read", "Ljava.sql.Date;", 0x21, "Ljava.io.IOException;", "(Lcom/google/gson/stream/JsonReader;)Ljava/sql/Date;" },
    { "writeWithDPGSStreamJsonWriter:withId:", "write", "V", 0x21, "Ljava.io.IOException;", "(Lcom/google/gson/stream/JsonWriter;Ljava/sql/Date;)V" },
...
- (DPGSTypeAdapter *)createWithDPGSGson:(DPGSGson *)gson
               withDPGSReflectTypeToken:(DPGSReflectTypeToken *)typeToken {
  return [((DPGSReflectTypeToken *) nil_chk(typeToken)) getRawType] == (id) JavaSqlDate_class_() ? new_ComGoogleGsonInternalBindSqlDateTypeAdapter_init() : nil;
}
