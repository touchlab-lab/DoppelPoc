...
+ (void)initialize {
  if (self == [AndroidSystemCloseGuard class]) {
    ...
    (void) JreVolatileStrongAssignAndConsume(&AndroidSystemCloseGuard_REPORTER, new_AndroidSystemCloseGuard_DefaultReporter_init());
...
AndroidSystemCloseGuard *new_AndroidSystemCloseGuard_init() {
  J2OBJC_NEW_IMPL(AndroidSystemCloseGuard, init)
}

AndroidSystemCloseGuard *create_AndroidSystemCloseGuard_init() {
  J2OBJC_CREATE_IMPL(AndroidSystemCloseGuard, init)
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "init", "DefaultReporter", NULL, 0x2, NULL, NULL },
  };
...
AndroidSystemCloseGuard_DefaultReporter *new_AndroidSystemCloseGuard_DefaultReporter_init() {
  J2OBJC_NEW_IMPL(AndroidSystemCloseGuard_DefaultReporter, init)
}

AndroidSystemCloseGuard_DefaultReporter *create_AndroidSystemCloseGuard_DefaultReporter_init() {
  J2OBJC_CREATE_IMPL(AndroidSystemCloseGuard_DefaultReporter, init)
}
