...
#include "retrofit/http/DELETE.h"
#include "retrofit/http/RestMethod.h"

@implementation RetrofitHttpDELETE
...
- (IOSClass *)annotationType {
  return RetrofitHttpDELETE_class_();
}

- (NSString *)description {
  return @"@retrofit.http.DELETE()";
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _RetrofitHttpDELETE = { 2, "DELETE", "retrofit.http", NULL, 0x2609, 2, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
  return &_RetrofitHttpDELETE;
}

@end

J2OBJC_INTERFACE_TYPE_LITERAL_SOURCE(RetrofitHttpDELETE)
