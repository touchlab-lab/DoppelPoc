...
#pragma push_macro("AndroidContentContext_INCLUDE_ALL")
#ifdef AndroidContentContext_RESTRICT
#define AndroidContentContext_INCLUDE_ALL 0
#else
#define AndroidContentContext_INCLUDE_ALL 1
#endif
#undef AndroidContentContext_RESTRICT

#if !defined (AndroidContentContext_) && (AndroidContentContext_INCLUDE_ALL || defined(AndroidContentContext_INCLUDE))
...
#pragma pop_macro("AndroidContentContext_INCLUDE_ALL")
