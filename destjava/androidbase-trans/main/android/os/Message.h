...
#pragma push_macro("AndroidOsMessage_INCLUDE_ALL")
#ifdef AndroidOsMessage_RESTRICT
#define AndroidOsMessage_INCLUDE_ALL 0
#else
#define AndroidOsMessage_INCLUDE_ALL 1
#endif
#undef AndroidOsMessage_RESTRICT

#if !defined (AndroidOsMessage_) && (AndroidOsMessage_INCLUDE_ALL || defined(AndroidOsMessage_INCLUDE))
...
#pragma pop_macro("AndroidOsMessage_INCLUDE_ALL")
