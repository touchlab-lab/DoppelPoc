...
#pragma push_macro("AndroidOsBundle_INCLUDE_ALL")
#ifdef AndroidOsBundle_RESTRICT
#define AndroidOsBundle_INCLUDE_ALL 0
#else
#define AndroidOsBundle_INCLUDE_ALL 1
#endif
#undef AndroidOsBundle_RESTRICT

#if !defined (AndroidOsBundle_) && (AndroidOsBundle_INCLUDE_ALL || defined(AndroidOsBundle_INCLUDE))
...
#pragma pop_macro("AndroidOsBundle_INCLUDE_ALL")
