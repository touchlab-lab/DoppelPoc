...
+ (void)initialize {
  if (self == [AndroidDatabaseSqliteSQLiteGlobal class]) {
    AndroidDatabaseSqliteSQLiteGlobal_sLock = new_NSObject_init();
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "TAG", "TAG", 0x1a, "Ljava.lang.String;", &AndroidDatabaseSqliteSQLiteGlobal_TAG, NULL, .constantValue.asLong = 0 },
    { "sLock", "sLock", 0x1a, "Ljava.lang.Object;", &AndroidDatabaseSqliteSQLiteGlobal_sLock, NULL, .constantValue.asLong = 0 },
    { "sDefaultPageSize", "sDefaultPageSize", 0xa, "I", &AndroidDatabaseSqliteSQLiteGlobal_sDefaultPageSize, NULL, .constantValue.asLong = 0 },
  };
  static const J2ObjcClassInfo _AndroidDatabaseSqliteSQLiteGlobal = { 2, "SQLiteGlobal", "android.database.sqlite", NULL, 0x11, 11, methods, 3, fields, 0, NULL, 0, NULL, NULL, NULL };
...
AndroidDatabaseSqliteSQLiteGlobal *new_AndroidDatabaseSqliteSQLiteGlobal_init() {
  AndroidDatabaseSqliteSQLiteGlobal *self = [AndroidDatabaseSqliteSQLiteGlobal alloc];
  AndroidDatabaseSqliteSQLiteGlobal_init(self);
  return self;
}

AndroidDatabaseSqliteSQLiteGlobal *create_AndroidDatabaseSqliteSQLiteGlobal_init() {
  return new_AndroidDatabaseSqliteSQLiteGlobal_init();
}
