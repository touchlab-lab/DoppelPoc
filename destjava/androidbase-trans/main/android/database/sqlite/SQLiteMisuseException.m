...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _AndroidDatabaseSqliteSQLiteMisuseException = { 2, "SQLiteMisuseException", "android.database.sqlite", NULL, 0x1, 2, methods, 0, NULL, 0, NULL, 0, NULL, NULL, NULL };
...
AndroidDatabaseSqliteSQLiteMisuseException *new_AndroidDatabaseSqliteSQLiteMisuseException_init() {
  AndroidDatabaseSqliteSQLiteMisuseException *self = [AndroidDatabaseSqliteSQLiteMisuseException alloc];
  AndroidDatabaseSqliteSQLiteMisuseException_init(self);
  return self;
}

AndroidDatabaseSqliteSQLiteMisuseException *create_AndroidDatabaseSqliteSQLiteMisuseException_init() {
  return new_AndroidDatabaseSqliteSQLiteMisuseException_init();
}
...
AndroidDatabaseSqliteSQLiteMisuseException *create_AndroidDatabaseSqliteSQLiteMisuseException_initWithNSString_(NSString *error) {
  return new_AndroidDatabaseSqliteSQLiteMisuseException_initWithNSString_(error);
}
