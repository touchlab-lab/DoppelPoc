...
#pragma push_macro("AndroidDatabaseCursorWindow_INCLUDE_ALL")
#ifdef AndroidDatabaseCursorWindow_RESTRICT
#define AndroidDatabaseCursorWindow_INCLUDE_ALL 0
#else
#define AndroidDatabaseCursorWindow_INCLUDE_ALL 1
#endif
#undef AndroidDatabaseCursorWindow_RESTRICT

#if !defined (AndroidDatabaseCursorWindow_) && (AndroidDatabaseCursorWindow_INCLUDE_ALL || defined(AndroidDatabaseCursorWindow_INCLUDE))
...
#pragma pop_macro("AndroidDatabaseCursorWindow_INCLUDE_ALL")
