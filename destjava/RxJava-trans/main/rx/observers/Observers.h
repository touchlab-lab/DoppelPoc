...
#pragma push_macro("RxObserversObservers_INCLUDE_ALL")
#ifdef RxObserversObservers_RESTRICT
#define RxObserversObservers_INCLUDE_ALL 0
#else
#define RxObserversObservers_INCLUDE_ALL 1
#endif
#undef RxObserversObservers_RESTRICT

#if !defined (RxObserversObservers_) && (RxObserversObservers_INCLUDE_ALL || defined(RxObserversObservers_INCLUDE))
...
#pragma pop_macro("RxObserversObservers_INCLUDE_ALL")
